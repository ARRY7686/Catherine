...
//finding magic numbers for the bitboards
U64 findMagicNumber(int square,int relevantBits,int bishop){
    ...
    std::cout<<"failure in magic number generation"<<std::endl;
    return 0ULL;

}
void initMagicNumbers(){
    //initializing the magic numbers for the bishops and rooks
    for(int square = 0;square<64;square++){
        bishopMagicNumbers[square] = findMagicNumber(square,bishopRelevantBits[square],1);
    }
    for(int square = 0;square<64;square++){
        rookMagicNumbers[square] = findMagicNumber(square,rookRelevantBits[square],0);
    }
}
